...
import type { BlendShapeCategory, Emotion } from '@/types'
...
// export function detectEmotion(blendShapes: BlendShapeCategory[]): Emotion {
...
//       maxEmotion = (key.charAt(0).toUpperCase() + key.slice(1)) as Emotion
